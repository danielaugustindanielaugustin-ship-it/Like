...
manager.addDocument('en', 'do you know where is the library', 'help.college');
manager.addDocument('en', 'where is the library', 'help.college');
manager.addDocument('en', 'what is the address of the library', 'help.college');
manager.addDocument('en', 'I need to go to the library', 'help.college');
manager.addDocument('en', 'I need to find a book', 'help.college');
manager.addDocument('en', 'I need to find a textbook', 'help.college');
manager.addDocument('en', 'I need to find a novel', 'help.college');
manager.addDocument('en', 'I need to find a literature book', 'help.college');
manager.addDocument('en', 'I need to find a book from the library', 'help.college');
manager.addDocument('en', 'I need to find a textbook from the library', 'help.college');
manager.addDocument('en', 'I need to find a novel from the library', 'help.college');
